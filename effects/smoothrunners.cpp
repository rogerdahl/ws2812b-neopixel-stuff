...
Ws281xEffectSmoothRunners::Ws281xEffectSmoothRunners(Ws281xString& pixels,
    u8 effectIdx, u8 speedFactor)
...
void Ws281xEffectSmoothRunners::refresh()
{
  ...
  for (u8 i = 0; i < numSegments_; ++i) {
    ...
    superPos = wrapAdd(superPos, segmentArr[i].speed / speedFactor_,
                       numSuperPositions);
...
void Ws281xEffectSmoothRunners::drawTaperedSegment(u16 superPos,
    u8 numSegmentPixels, const Color& c)
{
...
Color Ws281xEffectSmoothRunners::calcTaperedSegmentPixel(u8 numSegmentPixels,
    u8 pos, const Color& centerColor)
{
  ...
  return Color((u8)(rStep * segmentIndex), (u8)(gStep * segmentIndex),
               (u8)(bStep * segmentIndex));
}

void Ws281xEffectSmoothRunners::addPixelColor(u16 pixelPos,
